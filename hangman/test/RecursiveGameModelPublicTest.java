...
public class RecursiveGameModelPublicTest {
	@Rule
	public Timeout globalTimeout = Timeout.seconds(10); // 10 seconds

	private RecursiveGameModel model1;
	private RecursiveGameModel model2;

	@Before
	public void before() {
		model1 = new RecursiveGameModel("Zigzag");
		model2 = new RecursiveGameModel("Volume");
	}
