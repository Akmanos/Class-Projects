...
//	public Timeout globalTimeout = Timeout.seconds(10); // 10 seconds
	...
	private final SuspectEntry marc = new SuspectEntry("Marc", "413-545-3061", "1234567890", "5529");
	private final String marcLine = "Marc,413-545-3061,1234567890,5529";
	
	private final SuspectEntry garrett = new SuspectEntry("Garrett", "(413) 545-1985", "A72983752","2258");
	private final String garrettLine = "Garrett,(413) 545-1985,A72983752,2258";

	private final SuspectEntry mark = new SuspectEntry("Mark", "413 545 2744", "1234567890", "1129");
	private final String markLine = "Mark,413 545 2744,1234567890,1129";
	...
	public void testFull() throws Exception {
		assertEquals(Arrays.asList(
					new SuspectEntry("C. Sandiego", "(101) 117-0787", "1128946472366","9289"),
   				new SuspectEntry("Carmen S. Diego", "+1 222 345 6789", "1128946472366","7834"),
					new SuspectEntry("Carmen Sandiego", "(888)007-0787x267", "1128946472366","4356"),
					new SuspectEntry("Colonel Sanders", "1-800-CALL-KFC", "1128946472366","2323"),
					new SuspectEntry("La Mulana", "762-812-4698", "1128946472366","8769")),
				LogParser.findCommonEntries(
						Arrays.asList(
